...
if(!isset($_POST['perso']) || $_POST['perso'] === "p1"){
    ...
    echo "<img src = 'public/img/player.png' alt = 'player Luke' />";
    echo "</div>";
    echo "<div class='gauche'>";
    afficherPerso($p1);
    echo "</div>";
    ...
    echo "<div class='gauche'>";
    echo "<img src = 'public/img/playerF.png' alt = 'player Katy' />";
    echo "</div>";
    echo "<div class='gauche'>";
    afficherPerso($p2);
    echo "</div>";
    ...
    echo "<div class='gauche'>";
    echo "<img src = 'public/img/playerM.png' alt = 'player Marc' />";
    echo "</div>";
    echo "<div class='gauche'>";
    afficherPerso($p3);
    echo "</div>";
